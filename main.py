...
def start_command_handler(message):
    ...
    if unsubscribed_channels:
        ...
        reply_message = "لاستخدام الروبوت يجب عليك أولاً الاشتراك في هذه القنوات ⬇️"

        # إنشاء لوحة مفاتيح (Inline Keyboard) تحتوي على أزرار الاشتراك
        markup = types.InlineKeyboardMarkup()
        for channel in unsubscribed_channels:
            markup.add(types.InlineKeyboardButton(f"اشترك في {channel['id']} 👈", url=channel['url']))
