...
# RENDER_WEBHOOK_URL هو متغير بيئة يتم توفيره بواسطة Render ويحتوي على URL الأساسي لتطبيقك.
...
# وفقاً للتعليمات، لا تحتاج إلى توفير مفتاح API هنا؛ سيتم توفيره تلقائياً في بيئة Canvas.
GEMINI_API_URL = "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent"
GEMINI_API_KEY = "" # يُترك فارغاً، Canvas سيوفر المفتاح تلقائياً.

# -- قائمة الأوامر على اليسار (أزرار في لوحة المفاتيح) --
left_commands = ["star", "help"]

# --- قائمة يمين البوت: التبويبات 1 إلى 11 (أزرار في لوحة المفاتيح) ---
right_tabs = [
    "تقويم عام 1447ه‍.",
